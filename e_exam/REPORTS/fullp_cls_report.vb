...
Public Class fullp_cls_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "e_exam.fullp_cls_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfullp_cls_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fullp_cls_report = New fullp_cls_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
