...
Public Class NormExamResult
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "e_exam.NormExamResult.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNormExamResult
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NormExamResult = New NormExamResult()
        rpt.Site = Me.Site
        Return rpt
    End Function
